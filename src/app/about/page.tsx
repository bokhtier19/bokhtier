...
export default function AboutPage() {
    return (
        <section id="about" className="min-h-screen flex flex-col items-center justify-center px-6 py-20 gap-16">
            <div className=" lg:max-w-5xl mx-auto max-w-[70%]  items-center">
                {/* Heading */}
                <motion.h2 initial={{ opacity: 0, y: -30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="text-2xl md:text-4xl font-space font-bold text-center mb-12">
                    About Me
                </motion.h2>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center text-md">
                    ...
                    <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }} className="space-y-6">
                        ...
                        <p className="leading-relaxed  text-slate-500">
                            My journey started with building fun projects like <span className="text-primary">RhinoPad</span>, <span className="text-primary">Bark-and-Brawl</span>, and{" "}
                            <span className="text-primary">Skip-Leg-Day</span>. Over time, I’ve explored Next.js, React, Node.js, MongoDB, and real-time systems.
                        </p>
                        <p className="leading-relaxed ">
                ...
                {/* Education Section */}
                <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.2 }} viewport={{ once: true }} className="mt-12 space-y-4">
                    <h3 className="text-3xl font-bold text-green mb-4">Education</h3>
                    <ul className="list-disc list-inside space-y-2 text-text-muted">
                        <li>
                            <span className="font-semibold">Bachelor of Technology in Electronics and Communication</span> – Aligarh Muslim University, 2022
                        </li>
                        <li>
                ...
                <motion.div initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, delay: 0.3 }} viewport={{ once: true }} className="mt-16">
