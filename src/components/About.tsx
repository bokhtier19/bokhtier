...
export default function AboutPage() {
    return (
        <section id="about" className="min-h-screen max-w-[80%] flex items-center justify-center px-6 py-20">
                ...
                <div className="grid md:grid-cols-2 gap-12 items-center text-sm">
                    ...
                    <motion.div initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} transition={{ duration: 0.8 }} viewport={{ once: true }} className="space-y-6">
                        <p className="leading-relaxed font-inter">
                            Hello! I’m <span className="text-green font-semibold">Elius Bokhtier</span>, a frontend engineer passionate about crafting clean, modern, and interactive web experiences. I
                        ...
                        <p className="leading-relaxed font-inter text-slate-500">
                            My journey started with building fun projects like <span className="text-green">RhinoPad</span>, <span className="text-green">RhinoChat</span>, and{" "}
                            <span className="text-green">RhinoMovies</span>. Over time, I’ve explored Next.js, React, Node.js, MongoDB, and real-time systems.
                        </p>
                        <p className="leading-relaxed font-inter">
                            Outside of coding, I love experimenting with design, and I even built a quirky site about <span className="text-green">Street Fighter Dogs 🐶</span>. My goal is to keep
                            building products that people actually love to use.
                        </p>
                    </motion.div>
